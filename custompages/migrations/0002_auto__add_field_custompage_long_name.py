...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPage.long_name'
        db.add_column('custompages_custompage', 'long_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPage.long_name'
        db.delete_column('custompages_custompage', 'long_name')
    ...
    models = {
        ...
        'custompages.custompage': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'CustomPage', '_ormbases': ['pages.Page']},
